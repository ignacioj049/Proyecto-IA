...
def main():
    ...
    seleccion = greedy_priorizacion(
        df,
        horas_disponibles=horas_pabellon,
    ...
    print(f"Días de postergación usados para pendientes: {dias_postergacion}")
