...
class Paciente:
    ...
    def calcular_score_dinamico(self, pesos_dinamicos: Dict[str, float], 
                                minutos_proyectados: int, tasas_lambda: Dict[str, List[float]]) -> float:
        score = 0.0
        dias_extra = minutos_proyectados / 1440.0
        ...
        for var, alpha_base in self.vars_dinamicas_base.items():
            alpha_din = alpha_dinamico(alpha_base, lambdas_paciente, t_total_dias)  # orden nuevo
    ...
    def obtener_riesgo_total(self, pesos_estaticos: Dict[str, float], pesos_dinamicos: Dict[str, float], 
        ...
        s_dinamico = self.calcular_score_dinamico(pesos_dinamicos, minutos_proyectados, tasas_lambda)
